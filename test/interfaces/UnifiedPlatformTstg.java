...
public interface UnifiedPlatformTstg {
    ...
    void testEnterForm() throws NullArgumentException, WrongFormatException, IncorrectVerificationException, IncorrectFormException, ConnectException, NifNotRegisteredException;

    void testEnterCardData() throws NotValidPaymentDataException, InsufficientBalanceException, IncorrectFormException, ConnectException;

    void testObtainCertificate() throws DigitalSignatureException, IOException, BadPathException, NullArgumentException, WrongFormatException;
